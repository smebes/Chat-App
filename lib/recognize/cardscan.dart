...
import 'package:negotiation/recognize/app_color.dart';
import 'package:negotiation/recognize/custom_dialog.dart';

class CardScan extends StatefulWidget {
  CardScan({Key? key}) : super(key: key);
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('To verify your Account, please enter your CNIC details.',
                style: TextStyle(
                    fontSize: 15.0,
