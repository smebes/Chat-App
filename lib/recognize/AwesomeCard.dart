...
class AwesomeCard extends StatefulWidget {
  const AwesomeCard({ Key? key }) : super(key: key);

  @override
  State<AwesomeCard> createState() => _AwesomeCardState();
}

class _AwesomeCardState extends State<AwesomeCard> {
  String cardNumber = '';
